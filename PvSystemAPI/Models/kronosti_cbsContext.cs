...
namespace PvSystemAPI.Models
{
    public partial class kronosti_cbsContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
// this part of the is visible just for the demo
                optionsBuilder.UseSqlServer("Server=198.38.83.200;Database=kronosti_cbs;User ID=kronosti_cbs;Password=c3iwvosbfkqlnpaxgmhz");
            }
        }
